...
Next steps:
1. launchd plist - auto-start daemon on login
2. README.md - build and usage instructions for public release
3. Menu bar app - rumps-based, shows GPU temp / fan RPM / mode
